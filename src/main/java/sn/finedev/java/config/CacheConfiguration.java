package sn.finedev.java.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, sn.finedev.java.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, sn.finedev.java.repository.UserRepository.USERS_BY_EMAIL_CACHE);
