...
import sn.finedev.java.service.DepartmentQueryService;
import sn.finedev.java.service.DepartmentService;
...
/**
 * REST controller for managing {@link sn.finedev.java.domain.Department}.
 */
@RestController
@RequestMapping("/api")
