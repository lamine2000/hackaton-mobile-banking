...
/**
 * Criteria class for the {@link sn.finedev.java.domain.Department} entity. This class is used
 * in {@link sn.finedev.java.web.rest.DepartmentResource} to receive all the possible filtering options from
...
public class DepartmentCriteria implements Serializable, Criteria {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, name, code, createdAt, createdBy, distinct);
    }
