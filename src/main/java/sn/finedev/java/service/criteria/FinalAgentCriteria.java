...
/**
 * Criteria class for the {@link sn.finedev.java.domain.FinalAgent} entity. This class is used
 * in {@link sn.finedev.java.web.rest.FinalAgentResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /final-agents?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class FinalAgentCriteria implements Serializable, Criteria {
    ...
    public FinalAgentCriteria(FinalAgentCriteria other) {
    ...
    @Override
    public FinalAgentCriteria copy() {
        return new FinalAgentCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final FinalAgentCriteria that = (FinalAgentCriteria) o;
        return (
