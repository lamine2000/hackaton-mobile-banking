...
/**
 * Criteria class for the {@link sn.finedev.java.domain.IntermediateAgent} entity. This class is used
 * in {@link sn.finedev.java.web.rest.IntermediateAgentResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /intermediate-agents?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class IntermediateAgentCriteria implements Serializable, Criteria {
    ...
    public IntermediateAgentCriteria() {}

    public IntermediateAgentCriteria(IntermediateAgentCriteria other) {
    ...
    @Override
    public IntermediateAgentCriteria copy() {
        return new IntermediateAgentCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final IntermediateAgentCriteria that = (IntermediateAgentCriteria) o;
        return (
    ...
    public String toString() {
        return "IntermediateAgentCriteria{" +
            (id != null ? "id=" + id + ", " : "") +
