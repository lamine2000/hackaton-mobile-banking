...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './insurance-and-micro-credits-contribution.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INSURANCEANDMICROCREDITSCONTRIBUTION_LIST actions', async () => {
    ...
    it('dispatches SEARCH_INSURANCEANDMICROCREDITSCONTRIBUTIONS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_INSURANCEANDMICROCREDITSCONTRIBUTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_INSURANCEANDMICROCREDITSCONTRIBUTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_INSURANCEANDMICROCREDITSCONTRIBUTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_INSURANCEANDMICROCREDITSCONTRIBUTION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_INSURANCEANDMICROCREDITSCONTRIBUTION actions', async () => {
      const expectedActions = [
        {
