...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './ticket-delivery-method.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TICKETDELIVERYMETHOD_LIST actions', async () => {
    ...
    it('dispatches SEARCH_TICKETDELIVERYMETHODS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_TICKETDELIVERYMETHOD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TICKETDELIVERYMETHOD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TICKETDELIVERYMETHOD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TICKETDELIVERYMETHOD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TICKETDELIVERYMETHOD actions', async () => {
      const expectedActions = [
        {
