...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TICKETDELIVERY_LIST actions', async () => {
    ...
    it('dispatches SEARCH_TICKETDELIVERIES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_TICKETDELIVERY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TICKETDELIVERY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TICKETDELIVERY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TICKETDELIVERY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TICKETDELIVERY actions', async () => {
      const expectedActions = [
        {
