...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './intermediate-agent.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INTERMEDIATEAGENT_LIST actions', async () => {
    ...
    it('dispatches SEARCH_INTERMEDIATEAGENTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_INTERMEDIATEAGENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_INTERMEDIATEAGENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_INTERMEDIATEAGENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_INTERMEDIATEAGENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_INTERMEDIATEAGENT actions', async () => {
      const expectedActions = [
        {
