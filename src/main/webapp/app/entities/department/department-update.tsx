...
export const DepartmentUpdate = () => {
  ...
  const defaultValues = () =>
    isNew
      ...
      : {
          ...departmentEntity,
          createdAt: convertDateTimeFromServer(departmentEntity.createdAt),
        };
  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="hackaton3App.department.home.createOrEditLabel" data-cy="DepartmentCreateUpdateHeading">
            <Translate contentKey="hackaton3App.department.home.createOrEditLabel">Create or edit a Department</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('hackaton3App.department.name')}
                id="department-name"
                name="name"
                data-cy="name"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('hackaton3App.department.code')}
                id="department-code"
                name="code"
                data-cy="code"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('hackaton3App.department.createdAt')}
                id="department-createdAt"
                name="createdAt"
                data-cy="createdAt"
                type="datetime-local"
              ...
              />
              <ValidatedField
                label={translate('hackaton3App.department.createdBy')}
