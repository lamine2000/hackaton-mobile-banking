  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="hackaton3App.notification.home.createOrEditLabel" data-cy="NotificationCreateUpdateHeading">
            <Translate contentKey="hackaton3App.notification.home.createOrEditLabel">Create or edit a Notification</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('hackaton3App.notification.title')}
              ...
              />
              <ValidatedField
                label={translate('hackaton3App.notification.message')}
              ...
              />
              <ValidatedField
                label={translate('hackaton3App.notification.createdAt')}
              ...
              />
              <ValidatedField
                label={translate('hackaton3App.notification.sentTo')}
                id="notification-sentTo"
                name="sentTo"
                data-cy="sentTo"
                type="text"
                validate={{
              ...
              />
              <ValidatedField
                label={translate('hackaton3App.notification.sentBy')}
