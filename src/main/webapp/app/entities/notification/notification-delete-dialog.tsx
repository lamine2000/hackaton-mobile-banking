...
export const NotificationDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="hackaton3App.notification.delete.question">
        <Translate contentKey="hackaton3App.notification.delete.question" interpolate={{ id: notificationEntity.id }}>
