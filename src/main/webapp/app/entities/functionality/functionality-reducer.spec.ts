...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FUNCTIONALITY_LIST actions', async () => {
    ...
    it('dispatches SEARCH_FUNCTIONALITIES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_FUNCTIONALITY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FUNCTIONALITY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FUNCTIONALITY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FUNCTIONALITY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FUNCTIONALITY actions', async () => {
      const expectedActions = [
        {
