...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './mobile-banking-actor.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MOBILEBANKINGACTOR_LIST actions', async () => {
    ...
    it('dispatches SEARCH_MOBILEBANKINGACTORS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_MOBILEBANKINGACTOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_MOBILEBANKINGACTOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_MOBILEBANKINGACTOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_MOBILEBANKINGACTOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_MOBILEBANKINGACTOR actions', async () => {
      const expectedActions = [
        {
