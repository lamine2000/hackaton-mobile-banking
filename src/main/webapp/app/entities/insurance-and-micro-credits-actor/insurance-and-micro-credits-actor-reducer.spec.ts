...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './insurance-and-micro-credits-actor.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INSURANCEANDMICROCREDITSACTOR_LIST actions', async () => {
    ...
    it('dispatches SEARCH_INSURANCEANDMICROCREDITSACTORS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_INSURANCEANDMICROCREDITSACTOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_INSURANCEANDMICROCREDITSACTOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_INSURANCEANDMICROCREDITSACTOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_INSURANCEANDMICROCREDITSACTOR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_INSURANCEANDMICROCREDITSACTOR actions', async () => {
      const expectedActions = [
        {
