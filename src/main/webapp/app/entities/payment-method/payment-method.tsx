  ...
  return (
    <div>
      <h2 id="payment-method-heading" data-cy="PaymentMethodHeading">
        <Translate contentKey="hackaton3App.paymentMethod.home.title">Payment Methods</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="hackaton3App.paymentMethod.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/payment-method/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            ...
            &nbsp;
            <Translate contentKey="hackaton3App.paymentMethod.home.createLabel">Create new Payment Method</Translate>
          </Link>
        </div>
      </h2>
      <Row>
            ...
            <FormGroup>
              <InputGroup>
                <Input
                  ...
                  placeholder={translate('hackaton3App.paymentMethod.home.search')}
                />
        ...
        {paymentMethodList && paymentMethodList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="hackaton3App.paymentMethod.id">ID</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('name')}>
                  <Translate contentKey="hackaton3App.paymentMethod.name">Name</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('type')}>
                  <Translate contentKey="hackaton3App.paymentMethod.type">Type</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {paymentMethodList.map((paymentMethod, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>
                    <Translate contentKey={`hackaton3App.PaymentMethodType.${paymentMethod.type}`} />
                  </td>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="hackaton3App.paymentMethod.home.notFound">No Payment Methods found</Translate>
            </div>
          )
        )}
      </div>
