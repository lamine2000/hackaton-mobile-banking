...
export const PaymentMethodDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="hackaton3App.paymentMethod.delete.question">
        <Translate contentKey="hackaton3App.paymentMethod.delete.question" interpolate={{ id: paymentMethodEntity.id }}>
