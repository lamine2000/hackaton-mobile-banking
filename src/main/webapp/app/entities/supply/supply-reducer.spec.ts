...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SUPPLY_LIST actions', async () => {
    ...
    it('dispatches SEARCH_SUPPLIES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_SUPPLY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SUPPLY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SUPPLY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SUPPLY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SUPPLY actions', async () => {
      const expectedActions = [
        {
