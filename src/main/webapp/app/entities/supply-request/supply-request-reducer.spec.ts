...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SUPPLYREQUEST_LIST actions', async () => {
    ...
    it('dispatches SEARCH_SUPPLYREQUESTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_SUPPLYREQUEST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SUPPLYREQUEST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SUPPLYREQUEST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SUPPLYREQUEST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SUPPLYREQUEST actions', async () => {
      const expectedActions = [
        {
