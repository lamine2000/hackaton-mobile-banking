...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TOWN_LIST actions', async () => {
    ...
    it('dispatches SEARCH_TOWNS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_TOWN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TOWN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TOWN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TOWN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TOWN actions', async () => {
      const expectedActions = [
        {
