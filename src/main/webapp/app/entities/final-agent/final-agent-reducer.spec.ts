...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FINALAGENT_LIST actions', async () => {
    ...
    it('dispatches SEARCH_FINALAGENTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_FINALAGENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FINALAGENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FINALAGENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FINALAGENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FINALAGENT actions', async () => {
      const expectedActions = [
        {
