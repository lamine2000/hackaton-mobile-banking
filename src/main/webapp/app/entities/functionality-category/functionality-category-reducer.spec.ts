...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './functionality-category.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FUNCTIONALITYCATEGORY_LIST actions', async () => {
    ...
    it('dispatches SEARCH_FUNCTIONALITYCATEGORIES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_FUNCTIONALITYCATEGORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FUNCTIONALITYCATEGORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FUNCTIONALITYCATEGORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FUNCTIONALITYCATEGORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FUNCTIONALITYCATEGORY actions', async () => {
      const expectedActions = [
        {
