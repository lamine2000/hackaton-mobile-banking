...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ADMINNETWORK_LIST actions', async () => {
    ...
    it('dispatches SEARCH_ADMINNETWORKS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_ADMINNETWORK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ADMINNETWORK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ADMINNETWORK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ADMINNETWORK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ADMINNETWORK actions', async () => {
      const expectedActions = [
        {
