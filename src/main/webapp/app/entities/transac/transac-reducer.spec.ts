...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TRANSAC_LIST actions', async () => {
    ...
    it('dispatches SEARCH_TRANSACS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_TRANSAC actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TRANSAC actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TRANSAC actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TRANSAC actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TRANSAC actions', async () => {
      const expectedActions = [
        {
